...
class ZooKeeper(Employee):
    ...
    class SpecialtyChoice(models.TextChoices):
    ...
    specialty = models.CharField(
        max_length=10,
        choices=SpecialtyChoice.choices
    )
    ...
    def clean(self):
        if self.specialty not in ZooKeeper.SpecialtyChoice:
...
class ZooDisplayAnimal(Animal):
    ...
    def is_endangered(self):
        animal_type = ['Cross River Gorilla', 'Orangutan', 'Green Turtle']
        if self.species in animal_type:
